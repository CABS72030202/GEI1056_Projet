...
% STO estimation by maximizing the correlation between CP and rear part 
% of OFDM symbol estimates STO by maximizing the correlation between CP 
...
for n=1:N_ofdm
   ...
   if (Mag(n)>maximum)
     maximum=Mag(n); STO_est = N_ofdm-com_delay-n1; % N_ofdm-com_delay-n1; 
   end
end
